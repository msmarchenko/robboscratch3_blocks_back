      ...
      "args0": [
        {
          ...
          "options": [
            ...
            [Blockly.Msg.ROBOT_MAGENTA,                 'magenta'],
            [Blockly.Msg.ROBOT_YELLOW,                  'yellow'],
            [Blockly.Msg.ROBOT_GREEN,                   'green'],
            [Blockly.Msg.ROBOT_BLUE,                    'blue'],
            [Blockly.Msg.ROBOT_CYAN,                    'cyan'],
            [Blockly.Msg.ROBOT_BLACK,                   'black'],
            [Blockly.Msg.ROBOT_GRAY,                    'gray'],
            [Blockly.Msg.ROBOT_WHITE,                   'white'],
            [Blockly.Msg.ROBOT_UNKNOWN,                 'unknown']
...
Blockly.Blocks['robot_is_current_color'] = {
  /**
   * Block to turn left.
   * @this Blockly.Block
   */
  init: function(locale) {
    ...
    "message0": Blockly.Msg.ROBOT_IS_CURRENT_COLOR,
    "args0": [
      {
        "type": "input_value",
        "name": "ROBOT_SENSORS_FOR_RGB"
